...
| `ucode configure --enable-databricks-ai-tools --agents codex` | Install Databricks AI Tools for Codex explicitly |
...
Databricks AI Tools are installed for Claude by default. Codex does not install the skills and
plugins unless you explicitly pass `--enable-databricks-ai-tools` during configuration.
